...
class Admin::ActioncardsControllerTest < ActionController::TestCase
  ...
  test "should create actioncard" do
    assert_difference('Actioncard.count') do
      post :create, actioncard: { competency_id: @actioncard.competency_id, description: @actioncard.description, level_id: @actioncard.level_id }
    end
  ...
  test "should update actioncard" do
    patch :update, id: @actioncard, actioncard: { competency_id: @actioncard.competency_id, description: @actioncard.description, level_id: @actioncard.level_id }
    assert_redirected_to admin_actioncard_path(assigns(:actioncard))
  end
