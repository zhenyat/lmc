...
class Admin::CompetenciesControllerTest < ActionController::TestCase
  ...
  test "should create competency" do
    assert_difference('Competency.count') do
      post :create, competency: { cluster_id: @competency.cluster_id, description: @competency.description, name: @competency.name, position_id: @competency.position_id, title: @competency.title }
    end
  ...
  test "should update competency" do
    patch :update, id: @competency, competency: { cluster_id: @competency.cluster_id, description: @competency.description, name: @competency.name, position_id: @competency.position_id, title: @competency.title }
    assert_redirected_to admin_competency_path(assigns(:competency))
  end
